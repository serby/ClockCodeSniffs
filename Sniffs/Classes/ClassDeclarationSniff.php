 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Clock_Sniffs_Classes_ClassDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($curlyBrace + 1)]['content'] !== $phpcsFile->eolChar) {
            ...
            $error = "Opening $type brace must the last thing on a line";
            $phpcsFile->addError($error, $curlyBrace);
        }
        ...
        if ($tokens[($curlyBrace - 1)]['code'] === T_WHITESPACE) {
           ...
           $error = "Expected 1 spaces before opening brace; 0 found";
           $phpcsFile->addError($error, $curlyBrace);
        }
