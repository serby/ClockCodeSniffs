<?php
/**
 * Clock_Sniffs_Debug_CodeAnalyzerSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * Clock_Sniffs_Debug_CodeAnalyzerSniff.
 *
 * Runs the Clock Code Analyzer (from Clock Studio) on the file.
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Holger Kral <holger.kral@zend.com>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Clock_Sniffs_Debug_CodeAnalyzerSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (is_numeric($exitCode) === true && $exitCode > 0) {
            ...
            throw new PHP_CodeSniffer_Exception("Failed invoking ClockCodeAnalyzer, exitcode was [$exitCode], retval was [$retval], output was [$msg]");
        }
