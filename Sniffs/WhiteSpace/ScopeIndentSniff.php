 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Clock_Sniffs_WhiteSpace_ScopeIndentSniff implements PHP_CodeSniffer_Sniff
{
...
// I've taken this out to prevent double error reporting but it might be needed to detect some formatting errors - Serby
//        if ($tokens[$firstToken]['column'] !== $expectedIndent) {
//            $error  = 'Line indented sincorrectly; expected ';
//            $error .= ($expectedIndent - 1).' tabs, found ';
