 ...
 * @version   CVS: $Id: SwitchDeclarationSniff.php,v 1.18 2007/12/20 22:09:54 squiz Exp $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Clock_Sniffs_ControlStructures_SwitchDeclarationSniff implements PHP_CodeSniffer_Sniff
{
            ...
            if ($nextBreak !== false && isset($tokens[$nextBreak]['scope_condition']) === true) {
                ...
                if ($tokens[$nextBreak]['scope_condition'] === $nextCase) {
                    if ($tokens[$nextBreak]['column'] !== $caseAlignment + 1) {
                        $error = 'BREAK statement must be indented 2 tab from SWITCH keyword';
