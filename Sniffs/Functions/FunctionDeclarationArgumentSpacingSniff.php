 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Clock_Sniffs_Functions_FunctionDeclarationArgumentSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        while (($nextParam = $phpcsFile->findNext(T_VARIABLE, ($nextParam + 1), $closeBracket)) !== false) {
            ...
            if ($nextCode === T_EQUAL) {
                ...
                if ((($nextToken - $nextParam) > 2) || (($nextToken - $nextParam) == 0)){
                ...
                if ($tokens[($nextToken + 1)]['code'] !== T_WHITESPACE) {
                    ...
                    $arg   = $tokens[$nextParam]['content'];
                    $error = "Expected 1 spaces between default value and equals sign for argument \"$arg\"; 0 found";
                    $phpcsFile->addError($error, $nextToken);
                }
            }
